...
const dataRaw = [
  // Economia
  { group: 'Economia', subject: 'Economia', codes: ['Inf1','Inf2','Inf3','VM1','VM2','Coz2'], teachers: ['paulomaia', 'raquelvasconcelos'] },
  { group: 'Economia', subject: 'Economia', codes: ['Coz3'], teachers: ['raquelvasconcelos'] },
  { group: 'Economia', subject: 'Comércio e Serviços', codes: ['VM1'], teachers: ['danielaseco'] },
  { group: 'Economia', subject: 'Comércio e Serviços', codes: ['VM2','VM3'], teachers: ['raquelvasconcelos'] },
  { group: 'Economia', subject: 'Marketing', codes: ['VM1'], teachers: ['sandracardoso', 'nicolegama'] },
  { group: 'Economia', subject: 'Marketing', codes: ['VM2'], teachers: ['sandracardoso', 'nicolegama', 'danielaseco'] },
  { group: 'Economia', subject: 'Marketing', codes: ['VM3'], teachers: ['sandracardoso', 'fatimaferreira'] },
  { group: 'Economia', subject: 'Vendas', codes: ['VM1'], teachers: ['danielaseco'] },
  { group: 'Economia', subject: 'Vendas', codes: ['VM2'], teachers: ['sandracardoso', 'nicolegama', 'danielaseco'] },
  { group: 'Economia', subject: 'Vendas', codes: ['VM3'], teachers: ['sandracardoso', 'danielaseco'] },
  { group: 'Economia', subject: 'OEAG', codes: ['Inf1','Inf2','Inf3'], teachers: ['paulomaia'] },

  // LP / AISE / SI / TIC
  { group: 'LP / AISE / SI / TIC', subject: 'LP', codes: ['Inf1','Inf3'], teachers: ['ruibabo'] },
  { group: 'LP / AISE / SI / TIC', subject: 'LP', codes: ['Inf2'], teachers: ['cristianosa'] },
  { group: 'LP / AISE / SI / TIC', subject: 'AISE', codes: ['Inf1'], teachers: ['monicasimoes'] },
  { group: 'LP / AISE / SI / TIC', subject: 'AISE', codes: ['Inf2'], teachers: ['ruibabo'] },
  { group: 'LP / AISE / SI / TIC', subject: 'SI', codes: ['Inf2','Inf3'], teachers: ['monicasimoes'] },
  { group: 'LP / AISE / SI / TIC', subject: 'TIC', codes: ['Inf1','VM1','AS1','Mec.Aero1','TUR1'], teachers: ['monicasimoes'] },
  { group: 'LP / AISE / SI / TIC', subject: 'TIC', codes: ['Rest/Bar1','Copa1','Mec1','Mec.Auto1','Desp.1'], teachers: ['ruibabo'] },
